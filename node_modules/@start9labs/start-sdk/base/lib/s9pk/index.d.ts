import { DataUrl, DependencyMetadata, Manifest, MerkleArchiveCommitment, PackageId } from "../osBindings";
...
export declare class S9pk {
    ...
    dependencyMetadata(): Promise<Record<PackageId, DependencyMetadata>>;
