...
export declare class GetSystemSmtp {
     ...
     */
    watch(): AsyncGenerator<T.SmtpValue | null, void, unknown>;
    /**
     * Watches the system SMTP credentials. Takes a custom callback function to run whenever the credentials change
     */
    onChange(callback: (value: T.SmtpValue | null, error?: Error) => void | Promise<void>): void;
    /**
