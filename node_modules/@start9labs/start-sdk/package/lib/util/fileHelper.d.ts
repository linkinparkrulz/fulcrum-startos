...
type ReadType<A> = {
    ...
    onChange: (effects: T.Effects, callback: (value: A | null, error?: Error) => void | Promise<void>) => void;
...
export declare class FileHelper<A> {
     ...
     */
    static toml<A extends TOML.JsonMap>(path: ToPath, shape: Validator<TOML.JsonMap, A>): FileHelper<A>;
    static toml<A extends Transformed, Transformed = TOML.JsonMap>(path: ToPath, shape: Validator<Transformed, A>, transformers: Transformers<TOML.JsonMap, Transformed>): FileHelper<A>;
