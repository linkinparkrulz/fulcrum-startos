...
exports.oldSpecToBuilder = oldSpecToBuilder;
exports.default = makeFileContentFromOld;
...
async function oldSpecToBuilder(file, inputData, options) {
    await fs.writeFile(file, await makeFileContentFromOld(inputData, options), (err) => console.error(err));
}
function isString(x) {
    return typeof x === "string";
}
async function makeFileContentFromOld(inputData, { StartSdk = "start-sdk", nested = true } = {}) {
    const outputLines = [];
    outputLines.push(`
...
`);
    ...
    function convertList(value) {
        ...
        `);
                const listInputSpec = maybeNewConst(value.name + "_list_inputSpec", `
          InputSpec.of({
...
//   {},
// )
//# sourceMappingURL=oldSpecToBuilder.js.map